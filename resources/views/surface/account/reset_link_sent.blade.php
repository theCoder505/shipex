                ...
                <div class="grid items-start md:px-9">
                    <div class="mt-12">
                        ...
                        <p class="text-[16px] text-gray-500 mb-6">
                            If you have an account for Shipex, you will receive an email </br> within 5 minutes to reset
                            your password. Please follow the </br> instructions indicated in the email.
                        </p>
                    </div>
                </div>
