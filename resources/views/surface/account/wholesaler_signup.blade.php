            ...
            <div class="px-2 lg:px-8 w-full my-10 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="flex flex-col justify-center md:px-9" id="createForm">
                    <h2 class="text-xl lg:text-[40px] text-[#121212] mb-1">
                        Create an account as a wholesaler
                    </h2>

                    <p class="text-[16px] text-gray-500 mt-4 mb-2">
                        Already have an account?
                        <a href="/wholesaler/login" class="text-[#003FB4] underline">Sign in</a>
                    </p>

                    <p class="text-[16px] text-gray-500 mb-6">
                        Are you a manufacturer?
                        <a href="/manufacturer/signup" class="text-[#003FB4] underline">Register here</a>
                    </p>

                    <div class="max-w-[400px]">
                        <!-- Social Buttons -->
                        <div class="my-4 grid gap-5">
                            <a href="/wholesaler/social-signup/google"
                            ...
                            <a href="/wholesaler/social-signup/kakao"
                                class="border px-4 py-2 rounded-lg flex cursor-pointer gap-2 justify-center items-center border-[#BCBCBC] hover:bg-[#D6E2F7] text-sm">
                        ...
                        <div class="flex gap-2 items-start mt-3">
                            <input type="checkbox" name="agree_terms" id="agree_terms" class="w-5 h-5" required>
                            <label for="agree_terms" class="text-xs text-gray-500">
...
@section('scripts')
    <script>
        ...
        function verifyFormAndProceed() {
            ...
            if (!agreeTerms.checked) {
                Swal.fire({
                    ...
                    text: 'Please agree to the Privacy Policy and Terms of Use to continue.',
                    timer: 4000,
            ...
            if (isEmailValid && isPasswordValid) {
                ...
                // Make AJAX POST request to /wholesaler/verify-signup
                fetch('/wholesaler/verify-signup', {
                        method: 'POST',
                        headers: {
                    ...
                    .then(data => {
                        // Reset button state
                        submitBtn.disabled = false;
                        submitBtn.textContent = 'Create wholesaler account';
        ...
        function verifyOtp() {
            ...
            fetch('/wholesaler/otp-verification', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                ...
                .then(data => {
                    if (data.type === 'success') {
                        window.location.href = '/wholesaler/profile-setup';
                    } else {
                        // Show error
                        Swal.fire({
                            icon: 'error',
