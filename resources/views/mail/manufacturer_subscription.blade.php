...
<body
    style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f7fa; margin: 0; padding: 0;">
    <div class="email-container">
        <!-- Header -->
        <div class="header">
            <img src="{{ $brandlogo ?? 'logo.png' }}" alt="Brand Logo" class="logo" style="background: #f6f8fb">
            <h1 class="header-title" style="color: #ffffff">Account Status Update</h1>
        </div>
            ...
            @if ($status == 5)
                ...
                <div class="success-icon">
                    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M30 50 L45 65 L70 35" stroke="#ffffff" stroke-width="6" fill="none"
                ...
                <p class="message">
                    ...
                    <strong>{{ $brandname ?? 'SHIPEX' }}</strong> has been <strong
                        style="color: #48bb78;">approved</strong> by our admin team!
                </p>

                <p class="message">
                    Welcome to our growing network of trusted manufacturers. We're excited to have you on board and look
                ...
                <div class="info-box">
                    <h3>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" style="margin-right: 10px;">
                            <path d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" stroke="#667eea"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        Next Step: Choose Your Subscription Plan
                    </h3>
                    <p>To activate your account and start using our platform, please choose and complete your
                ...
                <p class="message" style="font-size: 14px; color: #718096;">
                    If you have any questions or need assistance with the subscription process, our support team is here
                    to help.
                </p>
            @elseif($status == 1)
                <!-- Under Review Status -->
                <div class="info-icon">
                    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M50 30 L50 55 M50 65 L50 70" stroke="#ffffff" stroke-width="6"
                ...
                <p class="message">
                    Your application to join <strong>{{ $brandname ?? 'SHIPEX' }}</strong> is currently <strong
                        style="color: #4299e1;">under review</strong> by our admin team.
                </p>

                <p class="message">
                    We are carefully evaluating your application details. Your account has been kept as
                    <strong>verified</strong> during this review process.
                </p>
                ...
                <div class="info-box" style="border-left-color: #4299e1;">
                    ...
                    <p>Your account remains verified while our team completes the review process. We'll notify you as
                        soon as a decision has been made.</p>
                </div>

                <p class="message">
                    This process typically takes 2-3 business days. You'll receive another notification once the review
                    is complete.
                </p>
            ...
            @elseif($status == 3)
                ...
                <div class="warning-icon">
                    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M35 35 L65 65 M65 35 L35 65" stroke="#ffffff" stroke-width="6"
                            stroke-linecap="round" />
                    </svg>
                </div>
                ...
                <p class="message">
                    We regret to inform you that your application to join <strong>{{ $brandname ?? 'SHIPEX' }}</strong>
                    has been <strong style="color: #f56565;">rejected</strong> by our admin team.
                </p>
                ...
                <div class="info-box"
                    style="border-left-color: #f56565; background: linear-gradient(135deg, #fff5f5 0%, #fed7d7 100%);">
                    <h3 style="color: #c53030;">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" style="margin-right: 10px;">
                            <path
                                d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"
                                stroke="#c53030" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        Application Status: Rejected
                    </h3>
                    <p>Unfortunately, your application did not meet our current requirements. This could be due to
                        incomplete information, policy violations, or other concerns identified during review.</p>
                </div>

                <p class="message">
                    We encourage you to review your application details and submit a new application if you believe you
                    can address the issues that led to this decision.
                </p>
                ...
                <p class="message" style="font-size: 14px; color: #718096;">
                    If you have questions about why your application was rejected or need assistance with the
                    reapplication process, please contact our support team.
                </p>
            @else
                ...
                <div class="info-box" style="border-left-color: #a0aec0;">
                    <h3 style="color: #4a5568;">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" style="margin-right: 10px;">
                            <path d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" stroke="#4a5568"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
