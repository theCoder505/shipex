                    ...
                    <tr>
                        <td style="padding: 24px 30px 30px 30px;">
                            ...
                            <p style="font-size: 15px; color: #4b5563; line-height: 1.7; margin-bottom: 24px; text-align: center;">
                                A new <strong>{{ $usertype ?? 'user' }}</strong> has just registered on <strong>{{ $brandname }}</strong> and successfully completed their business profile & submitted their application. Please review the details below.
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 20px 24px;">
                                        ...
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 12px;">
                                            <tr>
                                                <td width="40%" style="font-size: 14px; color: #6b7280; padding: 8px 0;">Full Name</td>
                                                <td width="60%" style="font-size: 14px; color: #111827; font-weight: 600; padding: 8px 0;">{{ $username ?? 'N/A' }}</td>
                                            </tr>
                                            <tr>
