            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {{-- <div>
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" id="auto_visibility_toggle" value="1"
                            {{ $settings->auto_visibility == 1 ? 'checked' : '' }} class="sr-only peer">
                        <div
                    ...
                    <input type="hidden" name="auto_visibility" id="auto_visibility" value="{{ $settings->auto_visibility == 1 ? 1 : 0 }}">
                </div> --}}
            </div>
        </div>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // $('#auto_visibility_toggle').on('change', function() {
            //     $('#auto_visibility').val($(this).is(':checked') ? 1 : 0);
            // });
        });
