                ...
                <tbody>
                    @foreach ($manufacturers as $manufacturer)
                        <tr>
                            ...
                            <td>
                                <form action="/admin/auto-visibility-setup" method="post">
                                @csrf
                                <input type="hidden" name="manufacturer_uid" value="{{$manufacturer->manufacturer_uid}}">
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" name="auto_visibility" class="sr-only peer" onchange="this.form.submit()" @if ($manufacturer->auto_visibility) checked @endif>
                                        <div class="w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-teal-300 dark:peer-focus:ring-teal-800 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-teal-600"></div>
                                    </label>
                                </form>
                            </td>
