...
@section('styles')
    <style>
        ...
        @media screen and (max-width: 800px) {
            ...
            .sent_message .time-container {
                justify-content: flex-end;
            }

            .received_message .time-container {
...
@section('content')
    <div class="h-screen flex flex-col">
        <!-- Header -->
        <div class="bg-white border-b border-gray-200 px-6 py-4 lg:block chat_header  @if ($spec_manufacturer != '') hidden @endif">
        ...
        <div class="grid lg:flex-1 lg:flex overflow-hidden">
            ...
            <div class="w-full lg:w-80 bg-white border-r border-gray-200 flex flex-col">
                <!-- Search Bar -->
                <div class="p-4 border-b border-gray-200 lg:block search_input_box @if ($spec_manufacturer != '') hidden @endif">
                ...
                <!-- Chat List -->
                <div class="lg:flex-1 lg:block overflow-y-auto chat_list  @if ($spec_manufacturer != '') hidden @endif">
                    @php
            ...
            <div class=" @if ($spec_manufacturer == '') hidden @endif lg:flex-1 lg:flex lg:flex-col bg-gray-50 relative overflow-y-auto chat_area">
                <!-- Chat Header -->
                @if ($spec_manufacturer == '')
                    <div class="bg-white border-b border-gray-200 px-6 py-4 flex items-center gap-4">
                        <svg class="w-12 h-12 text-gray-600 cursor-pointer absolute left-[-0.5rem] pr-2 back_arrow"
                            ...
                            stroke-linejoin="round" onclick="showChatList(this)">
                ...
                <div class="bg-white border-t border-gray-200 message-input-container">
                    ...
                    <div id="filePreview" class="mt-3 hidden px-2 lg:px-6">
                        <div class="flex items-center gap-3 bg-blue-50 p-3 rounded-lg">
                            ...
                            <button onclick="cancelFileUpload()" class="text-red-500 hover:text-red-700 flex-shrink-0">
