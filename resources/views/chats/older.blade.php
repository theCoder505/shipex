            ...
            <div class="w-80 bg-white border-r border-gray-200 flex flex-col">
                ...
                <div class="p-4 border-b border-gray-200">
                    <input type="text" placeholder="Search chats..."
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" onkeyup="searchChat(this)">
                </div>

                <!-- Chat List -->
                <div class="flex-1 overflow-y-auto chat_list">
                    @php
        ...
        $(document).ready(function() {
            if (spec_manufacturer_uid) {
                ...
                if (chatTab.length > 0) {
                    ...
                    @if ($spec_manufacturer)
                        $(".activated_user_img").attr('src', "{{ $spec_manufacturer->company_logo ? asset($spec_manufacturer->company_logo) : 'https://ui-avatars.com/api/?name=' . urlencode($spec_manufacturer->company_name_en) . '&background=3b82f6&color=fff' }}");
